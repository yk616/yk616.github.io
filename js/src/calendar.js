//js日历，来自https://www.cnblogs.com/loveyoume/p/6341567.html，已修改
(function(){
var calendar = function(calendarId){
    ...
    c.init = function(){
        ...
        loadStyles(".calendarDiv {width:361px;text-align:center;}\
            #headId{width:300px;height:auto;}\
            #calendarTable{width:300px;height:auto;}\
        ...
        //删除了.Table{width:330px;height:200px;}\
        c.buildPart({
            node : 'div',
            id : 'calendarDiv',
            className : 'calendar',
